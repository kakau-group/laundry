      ...
      <div class="container"><a class="navbar-brand text-primary font-weight-bold" href="index.php">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown"><a class="nav-link" id="navbarDropdown" href="#" role="button" data-toggle="dropdown" aria-expanded="false">Investasi</a>
              <ul class="dropdown-menu navbar-dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item text-secondary p-3 border-bottom" href="tahapan-menjadi-franchisee.php">Tahapan Menjadi Mitra</a></li>
                <li><a class="dropdown-item text-secondary p-3 border-bottom" href="pilihan-paket-investasi.php">Pilih Paket Investasi</a></li>
                <li><a class="dropdown-item text-secondary p-3" href="dukungan-sistem-dan-manajemen.php">Dukungan Sistem Manajemen </a></li>
              </ul>
            </li>
            ...
            <li>
              <a class="btn btn-primary ml-auto hover-top-shadow" href="daftar-member.php">Daftar Sebagai Member</a>
            </li>
            ...
            <li>
              <a class="btn btn-primary  ml-auto hover-top-shadow" href="daftar-investor.php">Daftar Sebagai Investor</a>
            </li>
