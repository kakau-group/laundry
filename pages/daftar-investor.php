                      ...
                      <form class="needs-validation" novalidate>
                        <div class="row g-3">
                          ...
                          <div class="col-12">
                              ...
                              <select class="form-select"  name="rencana_investasi" aria-label="Default select example">
                          ...
                          <div class="col-12">
                              ...
                              <select class="form-select"  name="paket_investasi" aria-label="Default select example">
