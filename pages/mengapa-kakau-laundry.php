...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet" 
    ...
    <div class="card-body">
              <h3>Waralaba dengan start-up cost rendah, Payback Period kurang dari satu tahun</h3>
              <div class="card-body">
              </div>
              <div class="accordion" id="accordionExample">
                <div class="accordion-item">
                  ...
                  <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      Thaharah artinya bersuci atau menghilangkan kotoran. Adapun secara syar’i yang dimaksud ialah menghilangkan najis atau kotoran dengan tata cara yang telah ditentukan oleh syari’at. Kami sangat memahami akan pentingnya proses pencucian menggunakan konsep thaharah untuk menghasilkan pakaian yang bersih lagi suci sehingga dapat terbebas dari najis. Dimana kesucian sangat penting ketika menggunakan pakaian saat beribadah.
                  </div>
                </div>
                <div class="accordion-item">
                ...
                <div class="accordion-item">
                  ...
                  <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      Sesuai Moto kami laundry Kiloan Kualitas Berkelas, bahwa walaupun merupakan cuci kiloan kami tetap mengutamakan pelayanan dimana proses penggarapan mencuci disesuaikan logo washing care label pada pakaian. Sehingga pakaian anda menjadi lebih awet dan terjaga.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                ...
                <div class="accordion-item">
                  ...
                  <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      Air sebelum masuk ke alat UV di bersihkan dulu dari endapan yang terkandung didalamnya, sehingga air menjadi lebih murni dan bersih..
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                ...
                <div class="accordion-item">
                  ...
                  <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      Untuk memberikan pelayanan yang terbaik bagi pelanggan diperlukan sistem pencatatan modern.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  ...
                  <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      Ada wangi Lavender, Strawberry, Apple, Lemon, Tulip, Katrina, Fruty Fantasi, Lavender, Blue Molto, Apple Green Fantasy, Eternity, Floral, Aquafresh, Lili dan masih banyak lagi. Seharum parfum lho…
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  ...
                  <div id="collapseNine" class="accordion-collapse collapse" aria-labelledby="headingNine" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      Dengan jumlah berat pakaian yang banyak akan mendapat layanan antar-jemput secara gratis.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  ...
                  <div id="collapseTen" class="accordion-collapse collapse" aria-labelledby="headingTen" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      Dapatkan diskon khusus untuk pelanggan yang menjadi member Simply Fresh Laundry.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                ...
                <div class="accordion-item">
                  ...
                  <div id="collapseThirteen" class="accordion-collapse collapse" aria-labelledby="headingThirteen" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    Dari hasil penelitian civitas Fakultas MIPA – Kimia UGM diketahui bahwa limbah deterjen kami dapat menyuburkan tanaman dan menetralisir zat kimia aktif pada lingkungan. Dengan 5 keunggulan utama : Mengandung optical brightener mencerahkan pakaian, Mengandung oxygen aktif membersihkan pakaian hingga ke serat kain, Bubuk konsentrat hemat dalam pemakaian detergen, Hemat air & tenaga karena sedikit busa, Bahan baku ramah lingkungan.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  ...
                  <div id="collapseFourteen" class="accordion-collapse collapse" aria-labelledby="headingFourteen" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    Simply Fresh Laundry peroleh Penghargaaan diantaranya Tokoh Inspiratif Seputar Indonesia Award 2013 RCTI, Franchise & Business Opportunity Market Leader on Kilos Laundry Category 2015, Juara Asia Pacific Entrepreneur Award 2010 sebagai satu-satunya laundry di Indonesia yang meraih juara bersama dengan perusahaan besar sekalas Garuda Indonesia, MNC Group, dll.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  ...
                  <div id="collapseFifteen" class="accordion-collapse collapse" aria-labelledby="headingFifteen" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    Teliti sebelum investasi pastikan anda bekerjasama dengan perusahaan yang telah memiliki izin Waralaba resmi. Simply Fresh Laundry telah memiliki Surat Tanda Pendaftaran Waralaba (STPW) dari Dirjen Perdagangan Dalam Negeri, serta tergabung dalam Asosiasi Franchise Indonesia (AFI)
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  ...
                  <div id="collapseSixteen" class="accordion-collapse collapse" aria-labelledby="headingSixteen" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    Jam terbang 13 tahun Simply Fresh berdiri dengan semangat Kaizen (penyempurnaan dan inovasi secara berkelanjutan) membuat sistem yang dijalankan semakin teruji dan juga mudah di aplikasikan
                    </div>
                  </div>
                </div>
              </div>
